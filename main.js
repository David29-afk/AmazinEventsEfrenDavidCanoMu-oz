...
// Verificar que eventos esté definido
console.log(eventos);

for (let i = 0; i < eventos.length; i++) {
    const evento = eventos[i];

    // Definir la función pintarTargetas dentro del bucle
    function pintarTargetas(evento) {
        // Verificar que se obtiene el contenedor correctamente
    ...
    // Llamar a pintarTargetas con el evento actual
